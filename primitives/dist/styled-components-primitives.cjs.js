...
const supportsColor = _interopDefault(require('supports-color'));
const transformDeclPairs = _interopDefault(require('css-to-react-native'));
const memoize = _interopDefault(require('memoize-one'));
const reactPrimitives = _interopDefault(require('react-primitives'));
...
const _StyledNativeComponent = (function (InlineStyle) {
  const createStyledNativeComponent = function createStyledNativeComponent(target, options, rules) {
    ...
    var WrappedStyledNativeComponent = React__default.forwardRef((props, ref) => React__default.createElement(ParentComponent, _extends({}, props, {
